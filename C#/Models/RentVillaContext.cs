...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("data source = .\\SQLEXPRESS; initial catalog = RentVilla; integrated security=SSPI; TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ImageTable>(entity =>
        {
            ...
            entity.HasOne(d => d.Property).WithMany(p => p.ImageTables)
                ...
                .HasConstraintName("FK_PROPERTY_IMAGE");
        });
        ...
        modelBuilder.Entity<UserTable>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__user_tab__AB6E616465DD2D33").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.PropertyId, e.UserId }).HasName("PK_WISH");

            entity.ToTable("wishlist_table");

            entity.Property(e => e.PropertyId).HasColumnName("property_id");
            entity.Property(e => e.UserId).HasColumnName("user_id");
            entity.Property(e => e.WishlistStatus)
                .HasMaxLength(10)
                .HasColumnName("wishlist_status");

            entity.HasOne(d => d.Property).WithMany(p => p.WishlistTables)
                .HasForeignKey(d => d.PropertyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WISH_PROP");
